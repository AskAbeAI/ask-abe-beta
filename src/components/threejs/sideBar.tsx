...
const SideBar: React.FC<{}> = ({}) => {
	...
	return (
		<nav className="overflow-y-auto">
			<Button
				className="flex items-center py-2 pl-2 text-sm hover:bg-accent"
			...
			<TextSection activeTab={activeTab} setActiveTab={setActiveTab} />
...
const DetailsSection: React.FC<{
	...
	return (
		<div>
			<button
				className="flex pl-2 items-center w-full py-2 text-sm hover:bg-accent focus:outline-none"
...
const TableOfContentsSection: React.FC<{
	...
	return (
		<div>
			<button
				className="flex pl-2 items-center w-full py-2 text-sm hover:bg-accent focus:outline-none"
				onClick={() => setActiveTab("tableOfContents")}
			>
	...
	return (
		<div>
			...
			>
				...
				<Button>View Legislation Text</Button>
				{activeTab === "text" && (
					<span className="ml-2 w-2 h-2 bg-accent rounded-full"></span>
				)}
			</button>
...
const PrimarySourceSection: React.FC<{
	activeTab: string;
	setActiveTab: (tab: string) => void;
}> = ({ activeTab, setActiveTab }) => {
	return (
		<div>
			<button
				className="flex pl-2 items-center w-full py-2 text-sm hover:bg-accent focus:outline-none"
				onClick={() => setActiveTab("primarySource")}
			>
				<ScissorsIcon className="h-5 w-5 mr-2" />
				<Button>View Primary Source</Button>
...
const GraphSettingsSection: React.FC<{
	...
	return (
		<div>
			<button
				className="flex pl-2 items-center w-full py-2 text-sm hover:bg-accent focus:outline-none"
				onClick={() => setActiveTab("graphSettings")}
			>
				<ChartBarIcon className="h-5 w-5 mr-2" />
				<Button>3D Graph Settings</Button>
