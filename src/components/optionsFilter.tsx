...
const OptionsList: React.FC<OptionsListProps> = ({
	...
	const [showBadJurisdictionsPopup, setShowBadJurisdictionsPopup] =
		useState(false);
					...
					<div className="bg-extralightbg border-4 border-bonewhite font-body p-4 rounded-md shadow-inner">
						<div className="flex justify-end mb-4">
							<HiX
								className="cursor-pointer"
								size={24}
								onClick={() => setShowOptionSidebarOpen(false)}
							/>
						</div>
						<div className="text-center text-olivebrown font-bold text-lg font-body mb-4">
						...
						>
							<div>
								...
								>
									Federal
									<svg
										className={`w-2.5 h-2.5 ml-3 ${isHovered ? "text-olivebrown" : "text-green-300"}`}
										aria-hidden="true"
										fill="none"
										viewBox="0 0 10 6"
									>
							...
							<div className="flex justify-center pt-4">
								<button
									className="px-4 py-1 rounded bg-gray-100 shadow-inner text-olivebrown hover:bg-olivebrown hover:text-white"
