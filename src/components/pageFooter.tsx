...
const PageFooter: React.FC = () => {
  ...
  return (
    <section className="items-stretch bg-[#FAF5E6] flex w-full flex-col px-16 py-6 max-md:max-w-full max-md:px-5 shadow-inner">
      <div className="max-md:max-w-full">
        ...
        <div className="items-stretch flex w-fit max-w-full gap-3 mt-8 max-md:justify-center">
          <svg
            className="h-7 w-7"
            fill="currentColor"
            viewBox="0 0 24 24"
