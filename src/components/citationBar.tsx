...
const CitationBar: React.FC<CitationProps> = ({ open, setOpen, citationItems, activeCitationId }) => {
  ...
  return (
    <div className="h-auto max-h-full overflow-y-auto bg-[#FDFCFD] border-4 border-[#E4E0D2] p-2 w-full shadow-inner rounded-md">
      ...
      <button className="sticky top-0 inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-[#F8F8FA] transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-[#4A4643] group"
        ...
        <span className="relative w-full text-left transition-colors duration-200 ease-in-out font-dmsans group-hover:text-[#4A4643]">
