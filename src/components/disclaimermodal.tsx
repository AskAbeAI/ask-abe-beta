                ...
                <div className="relative p-4 w-full rounded-lg max-w-2xl">
                    <div className="relative bg-extralightbg rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="flex justify-end p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button
                                onClick={handleClose}
                                className="text-white font-raleway bg-olivebrown hover:bg-green-300 hover:text-olivebrown focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                            >
                                I accept
                            </button>
                        </div>
