...
export const DisclaimerModal: React.FC = () => {
	...
	return (
		<AlertDialog>
			...
			<AlertDialogContent>
				<AlertDialogHeader>
					<AlertDialogTitle>Educational Purpose Disclaimer?</AlertDialogTitle>
					<AlertDialogDescription>
						...
						I understand that this service does not replace professional legal consultation and that any reliance on the material presented is strictly for educational purposes only and at my own risk.  *It is recommended that you do not include any personal information, especially sensitive personal information in any of your queries. All inputs are recorded and stored. Please refer to the <a href="/privacy" className="font-blue underline">Privacy Policy</a> for more information.
					</AlertDialogDescription>
				</AlertDialogHeader>
				<AlertDialogFooter>
					<AlertDialogCancel>I Do Not Accept</AlertDialogCancel>
