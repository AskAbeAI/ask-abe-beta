...
<section>
      ...
      <section className="items-center bg-[#FCF8EE] shadow-inner flex flex-col px-56 max-md:px-5">
        <div className="items-center bg-[#FCF8EE] flex flex-col px-16 max-md:px-5">
          ...
          <div className="border bg-[#FCF9F3] self-stretch mt-4 mb-4 pl-8 pr-8 border-solid border-8 border-[#FEFDF9] shadow-inner max-md:max-w-full max-md:my-10 max-md:pl-5">
