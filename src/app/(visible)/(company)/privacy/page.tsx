...
export default function PrivacyPage() {
	return (
		<div className="h-auto w-screen bg-extralightbg">
			<div className="container max-width-lg bg-extralightbg">
				<div className="items-stretch bg-extralightbg flex flex-col justify-center px-24 py-12 max-md:px-5">
							...
							<div className="flex flex-col items-stretch w-full max-md:w-full max-md:ml-0">
								<div className="items-stretch flex grow flex-col pb-4 max-md:max-w-full max-md:mt-10">
									...
									<p className="text-black text-base leading-6 mt-10 max-md:max-w-full">
										This privacy notice for Ask Abe,
									...
									<p className="text-black text-base leading-6 max-md:max-w-full">
										When using our service, we collect all
										information that is included in any
										input fields, including any feedback you
										may provide. It is recommended that you
										do not under any circumstances reveal or
										include any personal information that is
										senesitive when interacting with our
										service. For development and
										improvements we record all data.
									</p>
									{/* <div className="items-stretch flex justify-between gap-2 mt-2 max-md:max-w-full max-md:flex-wrap">
                                <div className="bg-black flex w-0.5 shrink-0 h-[21px] flex-col" />
                                <p className="text-black text-sm leading-5 grow shrink basis-auto max-md:max-w-full">
									...
									<p className="text-black text-base leading-6 mt-5 max-md:max-w-full">
										Our services may contain liks to other
										website that are not opperated or owned
										by Ask Abe. The information that you
										share with Third Party Sites will be
										goverened by those Third Party Sites
										privacy notices and terms of service. By
										providing these links we do not infer
										that we have reviewed these sites.
									</p>
									...
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										(like your Discord or Twitter logins).
										...
										platform. We will use the information we
										receive only for the purposes that are
										described in this privacy notice or that
										are otherwise made clear to you on the
									...
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										express and/or implied consent depending
										on the applicable law, you have the
										right to withdraw your consent at any
										time. You can withdraw your consent at
										any time by contacting us by using the
										contact details provided in the section
										&quot;HOW CAN YOU CONTACT US ABOUT THIS
										NOTICE?&quot; below. However, please
										note that this will not affect the
										lawfulness of the processing before its
										withdrawal nor, when applicable law
										allows, will it affect the processing of
									...
									<p className="text-black text-base leading-6 mt-2 max-md:max-w-full">
										...
										can: Upon your request to terminate your
									...
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										dependent&apos;s use of the Services. If
										we learn that personal information from
									...
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										version will be effective as soon as it
										is accessible. If we make material
										changes to this privacy notice, we may
										notify you either by prominently posting
