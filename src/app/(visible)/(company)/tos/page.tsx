...
export default function TOSPage() {
	return (
		<div className="h-auto w-screen bg-muted">
			<div className="container max-width-lg bg-muted">
				<div className="items-stretch bg-muted flex flex-col justify-center px-24 py-12 max-md:px-5">
						...
						<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
							<div className="flex flex-col items-stretch w-full max-md:w-full max-md:ml-0">
								<div className="items-stretch flex grow flex-col pb-4 max-md:max-w-full max-md:mt-10">
									...
									<div className="items-stretch flex justify-between gap-2 mt-4 max-md:max-w-full max-md:flex-wrap">
									...
									<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
										We are Ask Abe (&quot;Company,&quot;
										&quot;we,&quot; &quot;us,&quot;
										&quot;our&quot;).
										<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
											We operate the website askabeai.com
											(the &quot;Site&quot;), as well as
											any other related products and
											services that refer or link to these
											legal terms (the &ldquo;Legal
											Terms&rdquo;) (collectively, the
											&ldquo;Services&rdquo;).
										</p>
										{/* <p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
                                        You can contact us by email at askabeai@gmail.com or by mail to __________, __________, United States.</p> */}
										<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
											These Legal Terms constitute a
											legally binding agreement made
											between you, whether personally or
											on behalf of an entity
											(&ldquo;you&rdquo;), and Ask Abe,
											concerning your access to and use of
											the Services. You agree that by
											accessing the Services, you have
											read, understood, and agreed to be
											bound by all of these Legal Terms.
											IF YOU DO NOT AGREE WITH ALL OF
											THESE LEGAL TERMS, THEN YOU ARE
										...
										<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
											...
											notice of any scheduled changes to
											the Services you are using. The
											modified Legal Terms will become
											effective upon posting. By
											continuing to use the Services after
										...
										<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
											...
											permitted to use or register for the
											Services.
										</p>
										<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
											We recommend that you print a copy
											of these Legal Terms for your
											records.
										</p>
									</p>

									<h4 className="text-black text-3xl font-bold leading-10 mt-10 pt-12 max-md:max-w-full">
										OUR SERVICES
									</h4>
									...
									<p className="text-black text-base leading-6 mt-5 max-md:max-w-full">
										...
										Although it does not form part of these
										Terms, it is an important document that
										you should read.
									</p>
									<h5 className="text-black text-lg font-bold leading-9 mt-8 pr-10 max-md:max-w-full max-md:mt-10">
									...
									<p className="text-black text-base leading-6 max-md:max-w-full">
										...
										Services, or otherwise when you contact
										us.
									</p>
									<h5 className="text-black text-lg font-bold leading-9 mt-8 pr-10 max-md:max-w-full max-md:mt-10">
										Your submissions
									...
									<p className="text-black text-base leading-6 max-md:max-w-full">
										...
										Services to understand the (a) rights
										you give us and (b) obligations you have
										when you post or upload any content
										through the Services.
									</p>
									<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
										<strong>Submissions:</strong> By
										directly sending us any question,
										comment, suggestion, idea, feedback, or
										other information about the Services
										(&ldquo;Submissions&rdquo;), you agree
										to assign to us all intellectual
										property rights in such Submission. You
										agree that we shall own this Submission
										and be entitled to its unrestricted use
										and dissemination for any lawful
									...
									<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
										...
										<ul className="list-disc mt-4 ml-12">
											<li>
												confirm that you have read and
												agree with our &ldquo;PROHIBITED
												ACTIVITIES&rdquo; and will not
												post, send, publish, upload, or
												transmit through the Services
												any Submission that is illegal,
												harassing, hateful, harmful,
												defamatory, obscene, bullying,
												abusive, discriminatory,
												threatening to any person or
												group, sexually explicit, false,
												inaccurate, deceitful, or
												misleading;
											</li>
											<li className="mt-4">
												to the extent permissible by
												applicable law, waive any and
									...
									<p className="text-black text-base leading-6 mt-6 max-md:max-w-full">
										...
										Submissions and you expressly agree to
										reimburse us for any and all losses that
										we may suffer because of your breach of
										(a) this section, (b) any third
                            ...
                            <p className="text-black text-sm leading-5 grow shrink basis-auto max-md:max-w-full">
                                Image caption goes here
									...
									<h5 className="text-black text-3xl font-bold leading-9 mt-16 max-md:max-w-full max-md:mt-10">
										USER REPRESENTATION
									</h5>
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										jurisdiction in which you reside; (5)
									...
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										the Services. You agree to keep your
									...
									<p className="text-black text-base leading-6 mt-5 max-md:max-w-full">
										...
										<ul className="list-disc mt-4 ml-10">
											<li>
												...
												other content from the Services
												to create or compile, directly
											...
											<li className="mt-4">
												...
												and other users, especially in
												any attempt to learn sensitive
											...
											<li className="mt-4">
												...
												harm, in our opinion, us and/or
												the Services.
											</li>
											<li className="mt-4">
												Use any information obtained
												from the Services in order to
											...
											<li className="mt-4">
												...
												to upload or to transmit)
												viruses, Trojan horses, or other
											...
											<li className="mt-4">
												...
												user or person or use the
												username of another user.
											</li>
											<li className="mt-4">
												Upload or transmit (or attempt
												to upload or to transmit) any
												material that acts as a passive
												or active information collection
												or transmission mechanism,
												including without limitation,
												clear graphics interchange
												formats (&ldquo;gifs&rdquo;),
												1x1 pixels, web bugs, cookies,
												or other similar devices
												(sometimes referred to as
												&ldquo;spyware&rdquo; or
												&ldquo;passive collection
												mechanisms&rdquo; or
												&ldquo;pcms&rdquo;).
											</li>
											<li className="mt-4">
											...
											<li className="mt-4">
												...
												of the Services designed to
												prevent or restrict access to
												the Services, or any portion of
												the Services.
											</li>
											<li className="mt-4">
									...
									<h4 className="text-black text-3xl font-bold leading-10 mt-10 pt-10 max-md:max-w-full">
										THIRD-PARTY WBSITES AND CONTENT
									</h4>
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										The Services may contain (or you may be
										sent via the Site) links to other
										websites (&ldquo;Third-Party
										Websites&rdquo;) as well as articles,
										...
										(&ldquo;Third-Party Content&rdquo;).
										...
										privacy practices, or other policies of
										or contained in the Third-Party Websites
										or the Third-Party Content. Inclusion
										of, linking to, or permitting the use or
										installation of any Third-Party Websites
										or any Third-Party Content does not
										imply approval or endorsement thereof by
										us. If you decide to leave the Services
										and access the Third-Party Websites or
										to use or install any Third-Party
										Content, you do so at your own risk, and
										you should be aware these Legal Terms no
										...
										other websites and from other companies,
										and we take no responsibility whatsoever
										in relation to such purchases which are
										...
										services. Additionally, you shall hold
										us blameless from any losses sustained
										by you or harm caused to you relating to
									...
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										YOUR USE OF THE SERVICES WILL BE AT YOUR
										...
										(5) ANY BUGS, VIRUSES, TROJAN HORSES, OR
										...
										RESPONSIBILITY FOR ANY PRODUCT OR
										SERVICE ADVERTISED OR OFFERED BY A THIRD
										PARTY THROUGH THE SERVICES, ANY
										HYPERLINKED WEBSITE, OR ANY WEBSITE OR
										MOBILE APPLICATION FEATURED IN ANY
										BANNER OR OTHER ADVERTISING, AND WE WILL
										NOT BE A PARTY TO OR IN ANY WAY BE
										...
										PRODUCT OR SERVICE THROUGH ANY MEDIUM OR
										IN ANY ENVIRONMENT, YOU SHOULD USE YOUR
									...
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										bound by our Privacy Policy posted on
										the Services, which is incorporated into
										these Legal Terms. Please be advised the
										Services are hosted in the United
										States. If you access the Services from
										any other region of the world with laws
										or other requirements governing personal
										data collection, use, or disclosure that
										differ from applicable laws in the
										United States, then through your
										continued use of the Services, you are
									...
									<p className="text-black text-base leading-6 mt-4 max-md:max-w-full">
										...
										RESERVE THE RIGHT TO, IN OUR SOLE
										...
										CONTAINED IN THESE LEGAL TERMS OR OF ANY
