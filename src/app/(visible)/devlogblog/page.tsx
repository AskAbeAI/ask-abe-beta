...
<div>
    <div className="bg-extralightbg flex w-full flex-col px-20 py-12 max-md:max-w-full max-md:px-5">
      <div className="items-stretch self-center flex w-[768px] max-w-full flex-col mt-16 pt-6 max-md:mt-10">
        <div className="text-black text-4xl font-header font-bold leading-10 max-md:max-w-full">
          Relaunching Ask Abe Beta 0.2
        </div>
        <div className="text-black font-body text-md leading-6 mt-6 max-md:max-w-full">
          In the heart of our transformative journey, a pivotal moment has arrived: the relaunch of Ask Abe Beta 0.2.
        ...
        <div className="text-black text-md font-body leading-6 mt-4 max-md:max-w-full">
        ...
        <div className="text-black text-2xl font-header font-bold leading-7 mt-16 max-md:max-w-full max-md:mt-10">
          Creating Value

        </div>
        <div className="text-black text-md font-body leading-6 mt-4 max-md:max-w-full">
          As part of our broader website redesign, integrating Ask Abe Beta 0.2 has been a critical focus.
        ...
        <div className="text-black text-md leading-6 mt-4 max-md:max-w-full">
          <h1 className="font-bold font-body">🔍  Expandable Citations: Personalized Information Access</h1>
          <p className="pt-4 font-body">In our pursuit of enhancing user experience, Ask Abe Beta 0.2 introduces Expandable Citations.
          ...
          <h1 className="font-bold pt-12 font-body">🔄 Clarification Question Answer Options: Streamlining Communication</h1>
          <p className="pt-4 font-body">We understand the value of your time and clarity in communication.
            That&apos;s why Ask Abe Beta 0.2 offers Clarification Question Answer Options. This new feature presents multiple-choice responses to clarifying questions, enabling you to quickly navigate towards the most accurate answer.
          ...
          <h1 className="font-bold pt-12 font-body">⚙️ Chat Options & Jurisdictions: Tailored Interaction</h1>
          <p className="pt-4 font-body"> We recognize that every user has unique needs. With this in mind, Ask Abe Beta 0.2 includes Chat Options & Jurisdictions.
          ...
          <h1 className="font-bold pt-12 font-body">🔄 Ask a Follow-Up Question: Continuous Engagement</h1>
          <p className="pt-4 font-body">Your curiosity shouldn&apos;t end with just one answer.
            With the launch of Ask Abe Beta 0.2, we introduce the ability to Ask a Follow-Up Question.
        ...
        <div className="text-black text-md leading-6 mt-9 max-md:max-w-full text-xl font-body">
          We celebrate the launch of Ask Abe Beta 0.2, but our journey is far from over.
