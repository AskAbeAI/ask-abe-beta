			...
			<div className="items-center bg-lightbg shadow-inner w-screen flex flex-col">
				...
				<div className="items-center bg-lightbg flex flex-col px-20 mt-16 mb-16 max-md:px-5 shadow-inner">
					<div className="text-black text-center text-xl font-body leading-24 max-w-screen-md mt-6 mb-6max-md:max-w-full max-md:mb-10">
						...
						individual with accessible, comprehensible legal
						knowledge through Ask Abe. This includes our commitment
						to keeping this invaluable tool free forever, and our
						ambition to expand its benefits globally. We envision a
						future where every citizen, regardless of background or
						location, is equipped with the tools to navigate the
						legal world confidently, contributing to a more just,
			...
			<div className="items-center bg-mainbg shadow-inner flex flex-col px-5 pt-16">
						...
						<div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
							<div className="items-stretch flex flex-col max-md:max-w-full max-md:mt-10">
								...
								<div className="text-black text-lg font-body leading-24 mt-6 max-md:max-w-full">
									...
									injustice. Society&apos;s reliance on paid
									legal services for basic understanding
									perpetuates inequities. Empowering everyone
									with essential legal knowledge is key to a
				...
				<div className="items-stretch flex w-full max-w-[1312px] justify-between py-16 gap-5 max-md:max-w-full max-md:flex-wrap max-md:my-10">
					...
					<div className="text-black text-lg font-body leading-24 grow shrink basis-auto self-start w-7/12 max-md:max-w-full">
						...
						engages users in conversations, asking intuitive
						questions to clarify and refine legal queries. This
						ensures that the information provided is accurate and
						tailored to each user&apos;s needs. Ask Abe simplifies
						the legal research process and enhances understanding,
						making legal knowledge accessible and personalized. By
						democratizing legal understanding, Ask Abe empowers
						individuals and fosters a more informed society,
						revolutionizing the way we interact with the legal world
					</div>
				</div>
			</div>
						...
						<div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
							<div className="items-stretch flex flex-col max-md:max-w-full max-md:mt-10">
								...
								<div className="text-black text-lg font-body leading-24 mt-4 max-md:max-w-full">
									Ask Abe, our AI tool, plays a key role in
									this empowerment. For individuals, legal
									knowledge from Ask Abe means navigating
									daily life with confidence, understanding
									rights and responsibilities in scenarios
									like signing a lease or knowing workplace
									rights. This clarity fosters security and
									proactive engagement in legal matters.
									Marginalized and underrepresented
									communities also gain from this accessible
									legal information. Ask Abe bridges the
									knowledge gap, helping these groups assert
									their rights and protect their interests. By
									democratizing legal knowledge, Ask Abe
									promotes social justice and levels the
									playing field.
									<div className="text-black text-lg font-body leading-6 mt-6 max-md:max-w-full">
										An informed society with knowledgeable
										citizens contributes positively, makes
										informed decisions, and actively
										participates in the democratic process.
										This fosters a culture of legal
							...
							<div className="flex grow justify-between gap-5 max-md:mt-10">
								<div className="self-stretch flex grow basis-[0%] flex-col">
									...
									<div className="self-stretch text-black text-base font-body leading-6 mt-4">
										We believe legal information is a
										fundamental right, not a luxury. By
										keeping Ask Abe free, we ensure
										everyone, regardless of economic status,
										has access to legal knowledge and
										empowerment. This commitment nurtures a
										more informed and fair society.
									</div>
								</div>
							</div>
						</div>
						<div className="flex flex-col items-stretch w-[33%] ml-5 max-md:w-full max-md:ml-0">
							<div className="flex grow justify-between gap-5 max-md:mt-10">
								<div className="self-stretch flex grow basis-[0%] flex-col">
									...
									<div className="self-stretch text-black text-base font-body leading-6 mt-4">
										We envision Ask Abe serving citizens
										worldwide, adapting to diverse legal
										systems and languages. By expanding
										globally, we aim to create a community
										where legal understanding is a shared
										resource, bringing informed legal
						...
						<div className="flex flex-col items-stretch w-[33%] ml-5 max-md:w-full max-md:ml-0">
							<div className="flex grow justify-between gap-5 max-md:mt-10">
								<div className="self-stretch flex grow basis-[0%] flex-col">
									...
									<div className="self-stretch text-black text-base font-body leading-6 mt-4">
										Balancing free access with expansion
										presents financial hurdles. We seek
										supporters who share our vision of
										universal legal empowerment. Your
										support is an investment in making legal
