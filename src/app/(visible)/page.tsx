...
export default function HomePage() {
	return (
		<div className="h-screen w-full bg-background">
			...
			{/* Landing Section */}
			<section className="items-center bg-card shadow-inner flex w-full flex-col pb-12 pt-8">
						...
						<div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
							<div className="items-stretch self-stretch flex flex-col mt-4 max-md:max-w-full">
								<Image
									...
									height={500}
								/>
								<p className="text-foreground text-lg pt-1 font-raleway leading-7 mt-6 max-md:max-w-full">
									A Conversational AI Legal Education Assistant
								</p>
							</div>
							<div className="items-fit flex max-w-full justify-between mt-10">
								<Link href="/playground"
									className="text-lg font-raleway rounded-sm font-bold px-6 py-3 leading-none bg-primary text-primary-foreground hover:bg-accent hover:text-accent-foreground">
					...
					<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
						<div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
							<div className="items-stretch flex flex-col max-md:max-w-full max-md:mt-10">
								<h1 className="text-secondary mt-16 text-5xl font-imfell font-semibold leading-[57.6px] max-md:max-w-full max-md:text-4xl">
									What is Ask Abe?
								</h1>
								<p className="text-foreground text-xl font-raleway font-light leading-12 mt-6 max-md:max-w-full">
									Ask Abe is an educational tool that helps users navigate complex legal frameworks and provides detailed legal information...
								</p>
							</div>
						</div>
			...
			{/* Second Section */}
			<section className="items-center shadow-inner bg-card flex w-full flex-col px-2 py-12 max-md:max-w-full max-md:py-24">
				<div className="mb-0 w-full max-w-[1312px] max-md:max-w-full max-md:mb-2.5">
					<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
						...
						<div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
							<div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
								<div className="items-stretch self-stretch flex flex-col mt-4 max-md:max-w-full">
									<h1 className="text-secondary text-5xl font-imfell font-semibold leading-[57.6px] max-md:max-w-full max-md:text-4xl">
										Democratizing Legal Knowledge For All, One Question At a Time
									</h1>
									<p className="text-foreground text-xl font-raleway font-light leading-7 mt-6 max-md:max-w-full">
										Our dream is to revolutionize the legal landscape, making legal literacy a common asset, not a privilege...
									</p>
								</div>
								<div className="items-stretch flex max-w-full gap-4 mt-10 self-start">
									<a href="/mission" className="text-foreground font-raleway text-base leading-6 whitespace-nowrap justify-center items-center grow px-5 py-3 border-solid border-secondary">
										Our Mission
									</a>
								</div>
							</div>
			...
			<section>
				<div className="flex-col items-center overflow-hidden relative flex min-h-[400px] px-20 max-md:px-5">
					...
					/>
					<div className="relative top-5/6 text-card text-center text-5xl font-raleway font-bold leading-[80px] max-w-screen-md mt-40 max-md:max-w-full max-md:mt-10">
						Ask Abe&apos;s Features
					</div>
				</div>
			</section>
			...
			<section className="items-center bg-muted shadow-inner flex flex-col px-56 max-md:px-5">
				<div className="items-center bg-muted flex flex-col px-16 max-md:px-5">
					<div className="self-center text-foreground text-center text-lg leading-7 max-w-screen-md mt-6 max-md:max-w-full">
					</div>
					<div className="bg-card self-stretch mt-10 mb-10 pl-8 pr-8 border-solid border-8 border-muted shadow-inner max-md:max-w-full max-md:my-10 max-md:pl-5">
						<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
							<div className="flex flex-col items-stretch w-[46%] max-md:w-full max-md:ml-0">
								<div className="justify-center items-start self-stretch flex flex-col my-auto max-md:max-w-full max-md:mt-10">
									<div className="self-stretch text-foreground text-4xl font-raleway font-bold leading-10 mt-2 max-md:max-w-full">
										Expandable Citations
									</div>
									<div className="self-stretch text-foreground font-raleway text-base leading-6 mt-6 max-md:max-w-full">
			...
			<div className="bg-[#FCF9F3] self-stretch mt-10 mb-10 pl-8 pr-8 border-solid border-8 border-[#FEFDF9] shadow-inner max-md:max-w-full max-md:my-10 max-md:pl-5">
				<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
					<div className="flex flex-col items-stretch w-[46%] max-md:w-full max-md:ml-0">
						<div className="justify-center items-start self-stretch flex flex-col my-auto max-md:max-w-full max-md:mt-10">
			...
			{/* Team Section */}
			<section className="items-center bg-muted flex flex-col px-5 shadow-inner">
				<div className="flex w-[768px] max-w-full flex-col items-stretch mt-16 mb-16 max-md:my-10">
					<h1 className="text-secondary text-center font-imfell text-5xl font-semibold leading-[58px] max-md:max-w-full max-md:text-5xl max-md:leading-[54px]">
						Our Team
					</h1>
						...
						<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
							<div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
								<div className="items-center flex grow flex-col max-md:mt-8">
									<img
										loading="lazy"
										src="/home/will.jpg" className="rounded-full w-32 h-32 object-cover"
										alt="Will Diamond"
									/>
									<h2 className="self-stretch text-foreground text-center text-xl font-raleway font-semibold leading-8 mt-6">
										Will Diamond
									</h2>
									<p className="self-stretch text-foreground text-center font-raleway text-lg leading-7">
										Co-Founder
									</p>
							...
							<div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
								<div className="items-center flex grow flex-col max-md:mt-8">
									<img
										loading="lazy"
										src="/home/madeline.jpg" className="rounded-full w-32 h-32 object-cover"
										alt="Madeline Kaufman"
									/>
									<h2 className="self-stretch text-foreground text-center text-xl font-raleway font-semibold leading-8 mt-6">
										Madeline Kaufman
									</h2>
