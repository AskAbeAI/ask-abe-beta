		...
		<div className="h-screen w-full bg-background">
					...
					<div className="flex flex-col container items-stretch w-8/12 ">
						<div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
							<div className="items-stretch self-stretch flex flex-col mt-4 max-md:max-w-full">
								<div className="text-foreground text-9xl font-body leading- max-md:max-w-full max-md:text-9xl">
									<Image
										src="/home/title1.png"
										alt="Legal Research Image"
										width={700}
			...
			<section className="items-center bg-background shadow-inner flex w-full flex-col pb-12 pt-8">
				<div className="gap-2 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
					<div className="flex flex-col items-stretch w-8/12 max-md:w-full max-md:ml-0">
						<Image
							src="/home/explore-page.png"
							className="aspect-[0.96] object-contain object-center w-full overflow-hidden max-md:max-w-full max-md:mt-10"
							alt="Explore Legislation"
							width={600}
							height={600}
						/>
					</div>
					...
					<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
						<div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
							<div className="items-stretch flex flex-col max-md:max-w-full max-md:mt-10">
								<h1 className="text-muted-foreground mt-16 text-5xl font-header font-semibold leading-[57.6px] max-md:max-w-full max-md:text-4xl">
									What is Ask Abe?
								</h1>
			...
			{/* Second Section */}
			<section className="items-center shadow-inner bg-muted flex w-full flex-col px-2 py-12 max-md:max-w-full max-md:py-24">
				<div className="mb-0 w-full max-w-[1312px] max-md:max-w-full max-md:mb-2.5">
					<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
						...
						<div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
							<div className="flex flex-col my-auto max-md:max-w-full max-md:mt-10">
								{/* <h2 className="text-foreground text-center font-body text-base font-semibold leading-6 self-stretch whitespace-nowrap max-md:max-w-full">
                Innovative
              </h2> */}
								<div className="items-stretch self-stretch flex flex-col mt-4 max-md:max-w-full">
								...
								<div className="items-stretch flex max-w-full gap-4 mt-10 self-start">
									<a
										href="/mission"
										className="text-foreground font-body font-body text-base leading-6 whitespace-nowrap justify-center items-center border grow px-5 py-3 border-solid border-muted-foreground"
									>
										Our Mission
									</a>
								</div>
			...
			<section>
				<div className="flex-col items-center overflow-hidden relative flex min-h-[400px] px-20 max-md:px-5">
					...
					/>
					<div className="relative top-5/6 text-card text-center text-5xl font-body font-bold leading-[80px] max-w-screen-md mt-40 max-md:max-w-full max-md:mt-10">
						Ask Abe&apos;s Features
					</div>
				</div>
			</section>
			...
			{/* Feature Section */}
			<section className="items-center bg-card shadow-inner flex flex-col px-56 max-md:px-5">
				<div className="items-center bg-card flex flex-col px-16 max-md:px-5">
					<div className="self-center text-card-foreground text-center text-lg leading-7 max-w-screen-md mt-6 max-md:max-w-full"></div>
					<div className="border bg-card self-stretch mt-10 mb-10 pl-8 pr-8 border-solid border-8 border-card shadow-inner max-md:max-w-full max-md:my-10 max-md:pl-5">
						<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
							<div className="flex flex-col items-stretch w-[46%] max-md:w-full max-md:ml-0">
								<div className="justify-center items-start self-stretch flex flex-col my-auto max-md:max-w-full max-md:mt-10">
									<div className="self-stretch text-foreground text-4xl font-body font-bold leading-10 mt-2 max-md:max-w-full">
			...
			{/* Team Section */}
			<section className="items-center bg-card flex flex-col px-5 shadow-inner ">
				<div className="flex w-[768px] max-w-full flex-col items-stretch mt-16 mb-16 max-md:my-10">
					<h1 className="text- text-center font-header text-5xl font-semibold leading-[58px] max-md:max-w-full max-md:text-5xl max-md:leading-[54px]">
						Our Team
					</h1>
						...
						<div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
							<div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
								<div className="items-center flex grow flex-col max-md:mt-8">
									<img
										loading="lazy"
										srcSet="/home/will.jpg"
										className="rounded-full w-32 h-32 object-cover"
										alt="Will Diamond"
									/>
									<h2 className="self-stretch text-foreground text-center text-xl font-body font-semibold leading-8 mt-6">
										Will Diamond
									</h2>
									<p className="self-stretch text-foreground text-center font-body text-lg leading-7">
										Co-Founder
									</p>
