    ...
    <div className="h-screen w-full bg-[#FAF5E6]">
      ...
      <div className="flex flex-col items-center gap-8 p-12 pl-56 pr-56 bg-[#FAF5E6]">
        ...
        <div className="bg-[#FEFDF9] rounded shadow-lg grid grid-cols-2 content-center">
          <div className="flex justify-center items-center p-6">
            <div className="text-center">
              <h2 className="text-xl font-montserrat font-bold mb-2 ">Step 1: Get Started</h2>
        ...
        <div className="bg-[#FEFDF9] rounded shadow-lg grid grid-cols-2 content-center">
          <div className="flex justify-center items-center p-6">
            <div className="text-center">
              <h2 className="text-xl font-montserrat font-bold mb-2 ">Step 2: Ask a Question:</h2>
              <p className="font-montserrat text-gray-600">
        ...
        <div className="bg-[#FEFDF9] rounded shadow-lg grid grid-cols-2 content-center">
          <div className="flex justify-center items-center p-6">
            <div className="text-center">
              <h2 className="text-xl font-montserrat font-bold mb-2 ">Step 3: Wait for Abe&apos;s Response:
              </h2>
              <p className="font-montserrat text-gray-600">
        ...
        <div className="bg-[#FEFDF9] rounded shadow-lg grid grid-cols-2 content-center">
          <div className="flex justify-center items-center p-6">
            <div className="text-center">
              <h2 className="text-xl font-montserrat font-bold mb-2 ">Step 4: Review Answers and Select the Best-Fitting Answer or Provide Your Own:
              </h2>
              <p className="font-montserrat text-gray-600">
        ...
        <div className="bg-[#FEFDF9] rounded shadow-lg grid grid-cols-2 content-center">
          <div className="flex justify-center items-center p-6">
            <div className="text-center">
              <h2 className="text-xl font-montserrat font-bold mb-2 ">Step 5: Access and Review Full Citations:</h2>
              <p className="font-montserrat text-gray-600">
