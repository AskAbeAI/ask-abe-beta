...
import { BaseResponse, QueryExpansionRequest, QueryExpansionResponse } from '@/lib/api_types';
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const legal_statements: string[] = await expandQueryHelper(request.base, openai, legal_questions);
