    ...
    return (
        <footer className=" mt-20 flex">
            <div className="grid grid-cols-1 gap-5">
                <div>
                    ...
                    <div className="bg-[#1A1B26] p-5 rounded-lg">
                        ...
                        <ul className="list-disc pl-5">
                            ...
                            <li><strong>Note</strong>: Your API key is not stored. You'll need to provide it for each session due to our strict non-storage policy to ensure user privacy and security. Please see below for more information.</li>
                        </ul>
                        <h3 className="text-xl font-medium">Step 2: Pose Your Legal Question</h3>
                        <ul className="list-disc pl-5">
                            <li>Ensure your question is <strong>well-formed</strong> and <strong>directly related</strong> to a legal concern based in the California Legal Code <a href="https://leginfo.legislature.ca.gov/faces/codes.xhtml"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="underline text-blue-500 hover:text-blue-700">
                                statutes
                            </a>.</li>
                            <li>Specificity and legal terminology (if known) will significantly bolster the precision of Abe's responses.</li>
                        </ul>
                ...
                <div>
                    <h2 className="text-3xl font-semibold text-center">API Key Security</h2>
                    <div className="bg-[#1A1B26] p-5 rounded-lg">
